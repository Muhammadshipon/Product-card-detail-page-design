...
const Review = () => {
  return (
    ...
    className="flex animate__animated animate__fadeInUp   animate__fast animate__repeat-1	1 flex-col lg:flex-row gap-10 justify-center lg:items-start items-center">
    {/* customer review  */}
...
<div className="flex flex-col w-full">
<textarea rows="3" placeholder="Message..." className="p-4 rounded-md resize-none text-gray-800 bg-gray-200"></textarea>
